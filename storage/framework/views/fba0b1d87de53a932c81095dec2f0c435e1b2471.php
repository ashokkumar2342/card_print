<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="<?php echo e(route('admin.user.approval.store')); ?>" method="post" class="add_form" button-click="btn_close,btn_user_approval_list">
                <?php echo e(csrf_field()); ?>

                <div class="row">
                <input type="hidden" name="op_id" value="<?php echo e($op_id); ?>"> 
                    <div class="col-lg-6">
