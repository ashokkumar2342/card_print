    ...
    <div class="container-fluid">
        ...
        <div class="card card-info"> 
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">    
                        <form action="<?php echo e(route('admin.voter.PrepareVoterListGenerate')); ?>" method="post" no-reset="true" class="add_form">
...
<script>
    function downloadWithPhoto(){ 
        $('#download_with_poto').attr('href','<?php echo e(route('admin.voter.PrepareVoterListPanchayatDownload',1)); ?>'+'?district_id='+$('#district_select_box').val()+'&block_id='+$('#block_select_box').val()+'&village_id='+$('#village_select_box').val()+'&ward_id='+$('#value_div_id').val());
    }
    function downloadWithoutPhoto(){  
        $('#download_without_poto').attr('href','<?php echo e(route('admin.voter.PrepareVoterListPanchayatDownload',2)); ?>'+'?district_id='+$('#district_select_box').val()+'&block_id='+$('#block_select_box').val()+'&village_id='+$('#village_select_box').val()+'&ward_id='+$('#value_div_id').val());
    }
</script> 
<?php $__env->stopPush(); ?>
