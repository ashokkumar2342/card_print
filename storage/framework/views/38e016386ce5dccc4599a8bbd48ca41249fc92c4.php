                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-primary"> 
                            <form action="<?php echo e(route('admin.Master.ward.store')); ?>" method="post" class="add_form" no-reset="true" select-triger="village_select_box">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <span class="fa fa-asterisk"></span>
                                        <select name="village" class="form-control select2" id="village_select_box" select2="true" data-table="ward_datatable" onchange="callAjax(this,'<?php echo e(route('admin.Master.ward.table')); ?>','ward_table')">
