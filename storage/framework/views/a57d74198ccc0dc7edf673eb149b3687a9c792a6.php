                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-primary"> 
                            <form action="<?php echo e(route('admin.Master.WardBandiStore')); ?>" method="post" select-triger="assembly_part_select_box" no-reset="true" no-reset="true" class="add_form">
