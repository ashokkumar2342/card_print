                            ...
                            <div class="card-body">
                                <div class="row">  
                                    <div class="col-lg-4 form-group">
                                        ...
                                        <select name="district" class="form-control select2" id="district_select_box" onchange="callAjax(this,'<?php echo e(route('admin.Master.DistrictWiseBlock',2)); ?>','block_select_box')">
                                    ...
                                    <span class="fa fa-asterisk"></span>
                                    <select name="ward" class="form-control multiselect" id="value_div_id" onchange="callAjax(this,'<?php echo e(route('admin.Master.WardWiseBooth')); ?>'+'?ward_id='+this.value+'&village_id='+$('#village_select_box').val(),'booth_select_box')">
