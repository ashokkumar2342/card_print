<div class="modal-dialog modal-lg">
  <div class="modal-content">
    ...
    <form action="<?php echo e(route('admin.Master.WardBandiReportGenerate')); ?>" method="post" target="blank">
        <?php echo e(csrf_field()); ?> 
        <div class="row"> 

          <input type="hidden" name="village" value="<?php echo e($village); ?>">
          <input type="hidden" name="assembly_part" value="<?php echo e($assembly_part); ?>">
