...
<link rel="stylesheet" type="text/css" href="//cdn.datatables.net/1.10.15/css/jquery.dataTables.min.css">
  <!-- summernote -->
  <link rel="stylesheet" href="<?php echo e(asset('admin_asset/plugins/summernote/summernote-bs4.css')); ?>">
  <!-- Google Font: Source Sans Pro -->
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
  

  <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">
  <link href="<?php echo asset('admin_asset/bootstrap-select/dist/css/bootstrap-select.css'); ?>"  rel="stylesheet" type="text/css">
  <link rel="stylesheet" href="<?php echo e(asset('admin_asset/plugins/select2/css/select2.min.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('admin_asset/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('admin_asset/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css')); ?>">
    ...
    <div class="wrapper">
      ...
      <?php echo $__env->make('admin.include.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; <?php echo e(date('Y')); ?> <a href="http://www.innovusine.com"></a>.</strong> All rights reserved.
        </footer>
...
<script src=<?php echo asset('admin_asset/dist/js/validation/common.js?ver=1'); ?>></script>
    ...
    <script src=<?php echo asset('admin_asset/bootstrap-select/dist/js/bootstrap-select.min.js'); ?>> 
    </script>
  <script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/js/select2.min.js"></script> 
 <script src=<?php echo asset('admin_asset/dist/js/summernote.js?ver=1'); ?>></script>
 <script src=<?php echo asset('admin_asset/dist/js/croppie.js?ver=1'); ?>></script>

<script src="<?php echo e(asset('admin_asset/plugins/select2/js/select2.full.min.js')); ?>"></script>
<script src="<?php echo e(asset('admin_asset/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js')); ?>"></script>
...
<?php echo $__env->make('admin.include.model', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
