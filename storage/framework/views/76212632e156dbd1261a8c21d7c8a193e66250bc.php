		...
		<?php
		 ...
		 ?>
		 		...
		 		<table width = "100%" style="padding: 2px;font-size: 12px;font-weight: bold;">
		 			<tr>
		 				<td style="text-align: left; padding-left: 5px" width="25%">
		 					<?php echo e($mainpagedetails[0]->village_mc_type); ?> : <?php echo e($mainpagedetails[0]->village); ?>

		 				</td>
		 				<td style="text-align: center;" width="50%">
		 					<?php echo e($mainpagedetails[0]->voter_list_type); ?> निर्वाचन नामावली  <?php echo e($mainpagedetails[0]->year); ?>

		 				</td>
		 				<td style="text-align: right; padding-right: 5px" width="25%">
		 					वार्ड संख्या : <?php echo e($mainpagedetails[0]->ward); ?>
		 	...
		 	?>
		 		...
		 		<table width = "100%" style="padding: 2px;font-size: 12px;font-weight: bold;margin-top:-5px;">
		 			<tr>
		 				<td style="text-align: left; padding-left: 5px" width="100%">
		 					मतदान केन्द्र संख्या व नाम: <?php echo e($mainpagedetails[0]->booth_no); ?> - <?php echo e($mainpagedetails[0]->booth_name); ?>
							...
							<tr>
								...
								<td style="text-align:center;" rowspan="4">
									...
									if ($printphoto==1){
							 		...
							 		?>
							 		<img src="<?php echo e($image); ?>" alt="" width="65px" height="70px">
									<?php
									}	
									?>
								</td>
		...
		?>	
			...
			<table width="100%" style="margin-top:5px;">
				<tr>
					...
					<td width="52%" align="right" style="text-align: right;font-size: 12px;word-spacing: 4px"> कुल <?php echo e($totalpage); ?> पृष्ठों का पृष्ठ <?php echo e($cpageno); ?></td>
		...
		?>	
			<table width="100%" style="margin-top:<?php echo e($lrem); ?>px;" >
				<tr>
					<td>
						&nbsp;
					</td>
