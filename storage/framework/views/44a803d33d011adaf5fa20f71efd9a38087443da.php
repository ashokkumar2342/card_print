<form action="<?php echo e(route('admin.import.AssemblyImportStore')); ?>" method="get" enctype="multipart/form-data" success-content-id="assembly_imported_table" no-reset="true" data-table-without-pagination="assembly_imported_datatable" class="add_form">
<div class="row">
