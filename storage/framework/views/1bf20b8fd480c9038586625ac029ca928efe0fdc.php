...
<div class="col-lg-3 form-group">
    ...
    <span class="fa fa-asterisk"></span>
    <select name="village" class="form-control select2" id="village_select_box" select2="true" onchange="callAjax(this,'<?php echo e(route('admin.Master.WardBandiFilter')); ?>','value_div_id')">
    ...
    <tbody>
        <?php $__currentLoopData = $DistrictBlockAssigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $DistrictBlockAssign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e(isset($DistrictBlockAssign->Villages->name_l) ? $DistrictBlockAssign->Villages->name_l : ''); ?></td> 
                        <td>
                            <a title="Delete" class="btn btn-xs btn-danger" select-triger="user_id" onclick="if (confirm('Are you Sure delete')){callAjax(this,'<?php echo e(route('admin.Master.DistrictBlockVillageAssignDelete',Crypt::encrypt($DistrictBlockAssign->id))); ?>') } else{console_Log('cancel') }"  ><i class="fa fa-trash"></i></a>
                        </td> 
                    </tr> 
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
