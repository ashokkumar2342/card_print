        ...
        <div class="gt_top3_wrap default_width">
            <div class="container">
                ...
                <div class="gt_hdr_3_ui_element">
                        ...
                        <li><a href="<?php echo e(route('try.demo')); ?>" title="">Try Demo</a></li>
                        ...
                        <li><i class="fa fa-user"></i><a href="<?php echo e(route('student.resitration.firststep')); ?>">New Admission</a></li>
            ...
            <div class="container">
                ...
                <nav class="gt_hdr3_navigation">
                    ...
                    <ul class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <li><a href="<?php echo e(route('try.demo')); ?>">Try Demo</a>
             ...
             <ul class="swiper-wrapper">
                ...
                <li class="swiper-slide">
                    ...
                    <div class="gt_banner_text gt_slide_3">
                        ...
                        <a href="<?php echo e(route('try.demo')); ?>">Try Demo</a>
                    </div>
                </li>
             </ul>
         </div>
