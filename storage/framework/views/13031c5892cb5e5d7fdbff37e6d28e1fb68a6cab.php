    ...
    <div class="container-fluid">
        ...
        <div class="card card-info"> 
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12"> 
                        <form action="<?php echo e(route('admin.Master.MappingBoothWardStore')); ?>" method="post" class="add_form" no-reset="true">
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-lg-6 form-group">
                                    ...
                                    <span class="fa fa-asterisk"></span>
                                    <select name="village" class="form-control select2" id="village_select_box" select2="true" data-table="ward_datatable" onchange="callAjax(this,'<?php echo e(route('admin.Master.MappingVillageWiseBooth')); ?>'+'?village_id='+$('#village_select_box').val(),'booth_select_box')">
                                ...
                                <div class="col-lg-6 form-group">
                                    ...
                                    <span class="fa fa-asterisk"></span>
                                    <select name="booth" class="form-control select2" id="booth_select_box" duallistbox="true" onchange="callAjax(this,'<?php echo e(route('admin.Master.MappingVillageOrBoothWiseWard')); ?>'+'?village_id='+$('#village_select_box').val(),'ward_select_box')">
